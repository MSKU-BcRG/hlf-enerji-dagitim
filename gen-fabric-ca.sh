...
setenv(){
    export FABRIC_CA_CLIENT_HOME=$PWD/fabric-ca/client/$1/$2
    export FABRIC_CA_SERVER_HOME=$PWD/fabric-ca/server/$1/$2
}
...
export FABRIC_CA_CLIENT_HOME=$PWD/fabric-ca/client/orderer/orderer
...
mkdir -p $FABRIC_CA_CLIENT_HOME/msp/admincerts
cp $PWD/fabric-ca/client/orderer/admin/msp/signcerts/* $FABRIC_CA_CLIENT_HOME/msp/admincerts
